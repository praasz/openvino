...
/**
 * @brief OpenVINO Runtime AsyncInferRequest concrete base implementation
 * @file openvino/runtime/async_infer_request.hpp
 */
...
/**
 * @brief Concrete base implementation of asynchronous multi staged inference request.
 *        To customize pipeline stages derived class should change the content
 *        of AsyncInferRequest::m_pipeline member container.
 ...
 *        derived class should call AsyncInferRequest::stop_and_wait() function in destructor.
 * @par Example
 ...
 */
class OPENVINO_RUNTIME_API AsyncInferRequest : public IAsyncInferRequest {
public:
...
private:
    ...
    struct DisableCallbackGuard {
        explicit DisableCallbackGuard(AsyncInferRequest* this_) : _this{this_} {
